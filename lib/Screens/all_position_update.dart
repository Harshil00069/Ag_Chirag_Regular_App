...
class AllPositionUpdate extends StatefulWidget {
  ...
  const AllPositionUpdate({super.key, required this.tradingsymbol, required this.exchange, required this.ltp,  required this.productType,required this.symboleToken, required this.positionList, required this.netqty});
...
class _AllPositionUpdateState extends State<AllPositionUpdate> {
  ...
  void initState() {
    ...
    for(int i=0;i< widget.positionList.length;i++){
      userListWithQty.add(GetUserListForOrder(
        ...
        userModel: widget.positionList[i].userModel!,
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
      ...
      title: Text('All Position Update', style: Font.bodyText1(),),
    ),
...
class GetUserListForOrder extends StatelessWidget {
  ...
  GetUserListForOrder({required this.userModel,required this.qty,required this.price});
