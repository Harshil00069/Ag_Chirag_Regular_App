                      ...
                      return AppButton(
                          onPress: () async {
                            ...
                            for (int i = 0; i < userListWithQty.length; i++) {
                              orderController.placeOrderList.add(PlaceOrderModel(
                                  ...
                                  symboltoken:
                                  "${widget.watchListModel.symboltoken}",
                                  transactiontype:
                            ...
                            var cleanList = orderController.placeOrderList
                                .map((e) => e.toJson())
                                .toList();
                            print(jsonEncode(cleanList));
                            orderController.getPlaceOrdersApi(
