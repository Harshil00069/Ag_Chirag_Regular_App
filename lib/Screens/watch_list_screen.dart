...
import 'basket_order_screen.dart';
...
class _WatchListScreenState extends State<WatchListScreen> {
  ...
  Timer? timer;
  SearchShareController searchShareController = Get.find();

  @override
  void initState() {
    // TODO: implement initState
    // timer = Timer.periodic(const Duration(seconds: 120 ), (Timer t) => GetSharePrice());
